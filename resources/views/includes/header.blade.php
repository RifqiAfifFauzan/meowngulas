<div class="main-header">
    ...
    <div class="logo-header" data-background-color="blue">
        ...
        <a href="index.html" class="logo">
            <img src="{{ asset ('img/meowngulas-navbar-kecil.png')}}" alt="navbar brand" class="navbar-brand">
        </a>
                        ...
                        <div class="dropdown-user-scroll scrollbar-outer">
                            <li>
                                <div class="user-box">
                                    ...
                                    <div class="u-text">
                                        <h4>Rifqi Afif Fauzan</h4>
                                        <p class="text-muted">rifqiafiffauzan@gmail.com</p><a href="profile.html" class="btn btn-xs btn-secondary btn-sm">View Profile</a>
                                    </div>
                                </div>
                            </li>
                            <li>
